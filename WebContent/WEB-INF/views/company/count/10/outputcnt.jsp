...
<body>
 <form:form id="fenye" name="fenye" action="${ctx}/company/count/queryOutPutCnt" method="post">
    <div id="content_top">
        <table class="jymf_table" >
            <tr class="table_1_tr">
            	<td>产品名称&nbsp;
	                <input name="productName" type="text" class="texts" value="${outPutCount.productName}" />
                <td> 
                <td>开始日期&nbsp;&nbsp;&nbsp;
                    <input name="startDate" type="text" class="Wdate" 
                    onclick="WdatePicker()" value="${outPutCount.startDate}" 
                    style="width:190px;height:25px;"/>
                <td>     
                <td>结束日期&nbsp;&nbsp;&nbsp;
                    <input name="endDate" type="text" class="Wdate" 
                    onclick="WdatePicker()" value="${outPutCount.endDate}"
                     style="width:190px;height:25px;"/>
                <td>   
    ...
    <table id="table_1" class="jymf_table table_border">
        <tr id="table_1_titlebar">
            ...
            <td class="jymf_td row_1" rowspan="1" colspan="1">出库总量</td>
            <td class="jymf_td row_1" rowspan="1" colspan="1">查询总次数</td>
            <td class="jymf_td row_1" rowspan="1" colspan="1">消费查询总量</td>
            <td class="jymf_td row_1" rowspan="1" colspan="1">可能窜货总量</td>     
        </tr>
        <c:forEach var="outPutCnt" items="${pageView.records}">

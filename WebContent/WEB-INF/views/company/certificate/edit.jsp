...
<form:form id="addform" modelAttribute="certificate" action="${ctx}/company/certificate/edit" method="post" enctype ="multipart/form-data" >
	<div class="head_describe">修改证书</div>
    <table border="0px" cellpadding="0" cellspacing="0" >
        <tr>
            <td style="padding:8px;">名&nbsp;&nbsp;称
             	<input name="id" type="hidden" class="text" value="${certificate.id}"/>
                <input name="name" type="text" class="text" value="${certificate.name}"/>
        ...
        <tr>
        	<td style="padding:8px;">检验检疫证
        		<span class="file-box">
                 ...
                 <input type="hidden" id="jyz" name="jyz" value="${certificate.jyz}"/> 
            ...
            <td style="padding:8px;">进口报关单
            	<span class="file-box">
                 ...
                 <input type="hidden" id="bgd" name="bgd" value="${certificate.bgd}"/>

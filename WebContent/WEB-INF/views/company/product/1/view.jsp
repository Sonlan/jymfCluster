...
<form:form id="viewform" modelAttribute="product" >
    <div class="add_top">
        ...
        <table border="0" cellpadding="0" cellspacing="0" >
            <tr>
                <td>产&nbsp;品&nbsp;名&nbsp;称&nbsp;
                    <input type="text" class="text readonly" disabled="true" value="${product.name}"/>
                </td>
                <td>
                    <span class="td">生&nbsp;&nbsp;产&nbsp;&nbsp;地
                        <input style="margin-left: 58px;" class="text readonly" disabled="true" 
            ...
            <tr>
                <td>产&nbsp;品&nbsp;主&nbsp;页&nbsp;
                    <input type="text" class="text readonly" disabled="true" value="${product.url}"/>
                </td>
                <td>
                    <span class="td">生&nbsp;&nbsp;产&nbsp;&nbsp;商
                        <input style="margin-left: 58px;" type="text" class="text readonly" disabled="true" 
        ...
        <table border="0"  cellpadding="0" cellspacing="0" >
            <tr align="center">
                <td>产&nbsp;品&nbsp;描&nbsp;述&nbsp;</td>
                <td>
                    <textarea class="product_textare readonly" disabled="true" >${product.description}</textarea>
                </td>
            </tr>
        </table>
    </div>

        ...
        <div class="head_describe">产品基本信息</div>
	     <table id="table_2" class="jymf_table2 table_border" width="300px">
	        <tr class="table_1_tr">
	            ...
	            <td width="60px">产品编号</td><td>${product.numberId}</td>
	        </tr>
	        <tr class="table_1_tr">
	            <td>生&nbsp;产&nbsp;地</td><td colspan="3">${product.origin}</td>
	        </tr>
	        <tr>
	            <td>生&nbsp;产&nbsp;商</td><td>${product.producer}</td>
	            <td>供&nbsp;货&nbsp;商</td><td>${product.supplier}</td>
	        </tr>

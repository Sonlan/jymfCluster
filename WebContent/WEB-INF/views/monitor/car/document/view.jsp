...
<form:form id="viewform" >
    <div class="add_top">
        ...
        <table id="table_2" class="jymf_table2 table_border">
	        <tr class="table_1_tr">
	            <td width="15%">合同ID</td><td width="35%">${carInfo.id}</td>
	     		<td width="15%">配件数量 </td><td width="35%">${document.count}</td>
	        </tr>
	        <tr class="table_1_tr">
                <td>生成时间</td><td colspan="3">${carInfo.createDate}</td>
            </tr>
            <tr class="table_1_tr">
                <td>车牌号</td><td>${carInfo.carno}</td>
                <td>电话号</td><td>${document.tel}</td>
            </tr>
            <tr class="table_1_tr">
                <td>发动机号</td><td>${carInfo.engineno}</td>
                <td>车架号</td><td>${carInfo.vin}</td>
            </tr>
            <tr class="table_1_tr">
                <td>首次消费时间</td><td>${document.consTime}</td>
                <td>消费地区</td><td>${document.consArea}</td>
            </tr>
        </table>
        
        <c:if test="${document.count ne '0' }">

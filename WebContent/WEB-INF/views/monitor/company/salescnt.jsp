...
<script>
    $().ready(function() {
        $("#monitor-salescnt").addClass("active");
...
<body>
<form:form id="fenye" name="fenye" action="${ctx}/monitor/company/salesCntQuery" method="post">
    <div id="content_top">
        <table class="jymf_table" >
            <tr class="table_1_tr">
                <td>产品名称&nbsp;&nbsp;&nbsp;
                    <input name="name" type="text" class="texts" value="${pro.name}"/>
                </td>
                <td><div style="margin-left: 20px;">&nbsp;</div></td>
                <td>开始日期&nbsp;&nbsp;&nbsp;
                    <input name="startDate" type="text" class="Wdate" 
                    onclick="WdatePicker()" value="${pro.startDate}" 
                    style="width:190px;height:25px;"/>
                <td>     
                <td>结束日期&nbsp;&nbsp;&nbsp;
                    <input name="endDate" type="text" class="Wdate" 
                    onclick="WdatePicker()" value="${pro.endDate}"
                     style="width:190px;height:25px;"/>
                <td>   
            ...
            <c:if test="${product.labelCnt ne '0'}">
                <td>
                    <a style="text-decoration:underline;" 
                       href="${ctx}/monitor/company/product/queryopt/${product.id}/${pro.startDate}/${pro.endDate}" 

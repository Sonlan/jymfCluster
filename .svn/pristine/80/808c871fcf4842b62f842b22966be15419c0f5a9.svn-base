...
<form:form id="editform" modelAttribute="product" action="${ctx}/company/product/cloneAdd" method="post" 
    ...
    <div class="add_top">
        ...
        <table border="0" cellpadding="0" cellspacing="0" >
            <tr>
                ...
                <td>产&nbsp;品&nbsp;编&nbsp;号&nbsp;</td>
                <td width="274px">
                    <input type="text" maxlength="13" class="text" name="numberId" value="${product.numberId}"/>
                </td>
            </tr>
            <tr>
                <td>产&nbsp;品&nbsp;主&nbsp;页&nbsp;</td>

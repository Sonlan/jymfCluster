...
function showdiv() { 
    ...
    document.getElementById("ifm_ID").src="${ctx}/agent/dialog/querySelect";
}
//隐藏遮罩层
function hidediv() {
...
<form:form id="addform" modelAttribute="labelIndex" action="${ctx}/agent/labelIndex/add" method="post">

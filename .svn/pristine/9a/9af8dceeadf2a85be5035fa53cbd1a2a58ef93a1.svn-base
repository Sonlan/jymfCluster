...
$(document).ready(function(){
    ...
    $("body").on("click",".toDetail",function(){
    	...
    	$(location).attr('href', '${ctx}/company/cultivation/update/'+escape($(this).attr('value'))+'-----'+CLId);
    });  
    function showMaterialBId(){
    	var params = $("#materialBatchId").val().split(",");
    	for(i=0;i<params.length;i++){
    		if(params[i]!=""){
    			var html = "<tr id='"+params[i]+"'><td><a class='toDetail' href='javascript:void(0);' value='"+params[i]+"'>"+params[i]+"</a>"+
	  			"</td>"+
	  			"<td><a href='javascript:void(0)' class='delMaterialBId' value='"+params[i]+"'>删除</a></td>"+
	  			"</tr>";
	  			$("#gx").append(html);
    		}
    	}	
...
<form:form id="addform" modelAttribute="cordycepsLogistic" action="${ctx}/company/trace/update" method="post" 
           enctype ="multipart/form-data">
     <input type="hidden" name="id" value="${cordycepsLogistic.id}"/>  
    ...
    <div class="add_top">
        ...
        <table border="0" cellpadding="0" cellspacing="0" >
            ...
            <tr>
                ...
                <td width="465px">
                    <select id="saleMethod" name="saleMethod" style="width:251px;height:30px;margin-left: 10px;line-height: 27px;font-size: 13px;" value="${cordycepsLogistic.saleMethod}">

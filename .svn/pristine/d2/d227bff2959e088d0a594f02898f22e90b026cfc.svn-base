...
<script>
    $().ready(function() {
        ...
        $("#cntBtn").click(function() {
            $(location).attr('href', '${ctx}/agent/product/salescnt');
        });
...
<form:form id="fenye" name="fenye" action="${ctx}/agent/product/query" method="post">
    <div id="content_top">
        <table class="jymf_table" >
            <tr class="table_1_tr">
                ...
                <td><input class="center_btn" id ="cntBtn" type="button" value="销售统计"/></td>
            </tr>
        </table>
    </div> 
    ...
    <table id="table_1" class="jymf_table table_border">
        <tr id="table_1_titlebar">
	        ...
	        <td class="jymf_td row_1" rowspan="1" colspan="1">编号</td>
	    ...
	    <td>${product.numberId}</td>
            ...
            <td>
                <div class="">
                    <a title="${product.cartype}">${product.cartype}</a>
                </div>
            </td>

 ...
 *
 */
public class CordycepsLogistic implements Serializable{
	/**
	 * 
	 */
	...
	@NumberFormat
	private String  startID;  //开始溯源码
	@NumberFormat
	private String  endID; //终止溯源码
	...
	public String getProInNum() {
		return proInNum;
	}
	public void setProInNum(String proInNum) {

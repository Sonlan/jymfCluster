...
public class AcInfo implements Serializable{
	 ...
	 * 冲突区域名称
	 */
	private String collisionAreaName;
	...
	public String getCollisionAreaName() {
		return collisionAreaName;
	}

	public void setCollisionAreaName(String collisionAreaName) {
		this.collisionAreaName = collisionAreaName;
	}
